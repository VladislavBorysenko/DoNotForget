...
public class EditTaskDialogFragment extends android.app.DialogFragment {
    ...
    public interface EditingTaskListener {
        void onTaskEdited(ModelTask newTask);
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        //Создаём диалог, наполняя данными из бандла
        ...
        //устанавливаем курсор в конце текста заголовка
        ...
        //Дату и время устанавливаем, какими они были первоначально
